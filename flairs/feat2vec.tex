...
\title{Feat2Vec for Embedding Data with Multiple Features Types}
...
In traditional factorization methods, individual item identifier are embedded and thus need to be observed during training (i.e., cold-start problem).
