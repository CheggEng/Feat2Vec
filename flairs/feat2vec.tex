...
First, Feat2Vec is the first algorithm that is able to calculate general-purpose embeddings with self-supervision that are useful for transfer learning.
...
Consider the non-trivial work that an engineer needs to do to extend a model like Word2Vec to support  additional features.
...
and extends StarSpace~\cite{wu2017starspace}, in that we do not constraint the feature groups to be  a ``bag of features''.
