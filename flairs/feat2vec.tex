...
In contrast, $\Feat2Vec$ allows continuous features, and does not require the user to assign a feature as a label; additionally, we propose a self-supervised learning algorithm.
