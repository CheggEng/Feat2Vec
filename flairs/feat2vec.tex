...
We study how to estimate  dense representations when multiple feature types (e.g., text, continuous, categorical) exist within a dataset.
...
\end{itemize}
In theory, any neural function that outputs a $r$-dimensional vector could be plugged into our framework as an extraction function $\phi$.
...
In contrast, $\Feat2Vec$ allows continuous features.
Our model does not require the user to assign a feature as a label, and we propose a self-supervised learning algorithm.
