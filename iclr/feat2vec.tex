...
\title{Feat2Vec:  Continuous Representations of Data with Features}
...
\subsection{Can $\Feat2Vec$ handle non-categorical inputs?}
...
Eventhough they intend to be able to embed ``all things'', at the time of writing this paper, their pre-print method was limited to only work for bag of words.
