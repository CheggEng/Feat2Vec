...
We do not optimize the embeddings of individual subfeatures, but we reason at more abstract levels of complexity.
...
\subsection{Does semantic modularity enables better embeddings?}
...
In order to test the relative performance of our learned embeddings, we train our $\Feat2Vec$ algorithm on an unstructured dataset, and compare its performance in a targeted ranking task to $\Word2Vec$. 
