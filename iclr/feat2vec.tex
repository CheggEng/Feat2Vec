...
Even though they intend to be able to embed ``all things'', at the time of the writing of this paper, their pre-print method was limited to only work for bag of words.
While $\Feat2Vec$ is a convex combination of all possible prediction tasks given the feature set,  StarSpace samples a single arbitrary feature.
