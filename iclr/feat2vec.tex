...
This results in retaining the full set of information for well over 95\% of our observations. \hl{check please}
...
\paragraph{Feat2Vec} 
Feature representation in $\Feat2Vec$ implies requires feature extraction function for each feature group.
