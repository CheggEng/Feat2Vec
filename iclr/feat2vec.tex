...
To learn this model we need positive and negative examples:
 a positive example occurs in the dataset, and a negative does not.
This is similar how a positive example in $\Word2Vec$ is a word-context pair drawn from the training documents, and negative examples are sampled.
